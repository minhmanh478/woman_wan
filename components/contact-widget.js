 ...
 * ============================================================================
 * Cách dùng:
 * 1. Nhúng script vào trang HTML:
 *    <script src="components/contact-widget.js" defer></script> (ở trang gốc)
 *    <script src="../components/contact-widget.js" defer></script> (ở trang con /product/, /checkout/)
 *
 * 2. Gọi widget trong trang:
 *    <womanwan-contact></womanwan-contact>
 *    (Widget cũng sẽ tự động hiển thị nếu chưa có thẻ trên trang)
 * ============================================================================
 */
...
(function () {
  ...
  // Khởi tạo Custom Element <womanwan-contact>
  ...
  // Tự động đảm bảo widget luôn xuất hiện trên trang
